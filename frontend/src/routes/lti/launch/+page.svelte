<script>
    ...
    onMount(async () => {
        ...
        try {
            ...
            const checkUserResponse = await fetch(`https://egp-broker.cs.vt.edu/egp-broker-service/api/user/${tokenData.user.name}`);
            ...
            if (checkUserResult.exists) {
                ...
                const loginResponse = await fetch('https://egp-broker.cs.vt.edu/egp-broker-service/api/login', {
                    method: 'POST',
                ...
                const registerResponse = await fetch('https://egp-broker.cs.vt.edu/egp-broker-service/api/register', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
