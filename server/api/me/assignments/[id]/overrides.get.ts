...
import { getAssignmentOverrides } from '@@/server/utils/teacher'

export default defineEventHandler(
  async (event): Promise<ApiResponse<AssignmentOverrideDetails[]>> => {
    ...
    const overrides = await getAssignmentOverrides(assignmentId, courseId)
