...
Did you want to:
1. Complete current milestone first (@[complete-milestone.md])
2. Add phases to current milestone (@[add-phase.md])
...
- options (ALL THREE REQUIRED):
  - "Create milestone" - Proceed to @[new-milestone.md]
...
**Status:** Ready for @[new-milestone.md]
...
*This file is temporary. It will be deleted after @[new-milestone.md] creates the milestone.*
EOF
```
</step>
...
- Context handed off to @[new-milestone.md]
</success_criteria>
