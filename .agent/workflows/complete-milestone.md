...
**Important:** The next milestone workflow starts with `@[define-requirements.md]` to create a fresh REQUIREMENTS.md. PROJECT.md's Validated section carries the cumulative record across milestones.
...
**Next milestone flow:**
1. `@[discuss-milestone.md]` — thinking partner, creates context file
2. `@[new-milestone.md]` — update PROJECT.md with new goals
3. `@[research-project.md]` — (optional) research ecosystem
4. `@[define-requirements.md]` — scope what to build
5. `@[create-roadmap.md]` — plan how to build it
...
- [ ] User knows next steps (starting with @[define-requirements.md])
