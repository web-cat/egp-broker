...
**If MILESTONE-CONTEXT.md exists (from @[discuss-milestone.md]):**
...
Phase: Not started (run @[create-roadmap.md])
Plan: —
...
**Or research first:**
- `@[research-project.md]` — investigate ecosystem before scoping

**Full flow:**
1. `@[define-requirements.md]` — create REQUIREMENTS.md
2. `@[create-roadmap.md]` — create ROADMAP.md with phases
3. `@[plan-phase.md] [N]` — start execution
